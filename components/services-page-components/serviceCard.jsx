...
const ServiceCard = ({ id, title,titleAR, imgSrc, iconSrc, brief,briefAR }) => {
  ...
  return (
    ...
    >
      ...
      <div className="it-container px-4 w-full h-full absolute text-white hover:bg-blue-800 transition-all duration-500 flex flex-col justify-center items-center gap-2">
        ...
        {t("placesDesc",{placesDesc:brief ,placesDescAR:briefAR})}
        </p>
        <Link
          to={`/services/${id}`}
          onClick={scrollToTop}
        ...
        >
          <div className="flex justify-between gap-3 items-center">
            <p className="duration-150">{t("ReadMore")} </p>
